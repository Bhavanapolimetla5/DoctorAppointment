  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border px-12 md:px-16  py-8 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
          <b>EFFICIENCY:</b>
